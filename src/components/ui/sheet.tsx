...
const dialogTitleDisplayName =
  SheetPrimitive.Title.displayName ?? "DialogTitle";
...
const containsDialogTitle = (children: React.ReactNode): boolean => {
  ...
  React.Children.forEach(children, (child) => {
    ...
    if (
      ...
      displayName === dialogTitleDisplayName
    ) {
      found = true;
      return;
    }

    if (child.props?.children && containsDialogTitle(child.props.children)) {
      found = true;
    }
  });
  ...
  (
    {
      ...
      className,
      children,
      "aria-label": ariaLabel = "Sheet dialog",
      fallbackTitle,
    ...
    const effectiveTitle = fallbackTitle ?? ariaLabel;
    ...
    return (
      <SheetPortal>
        ...
        <SheetPrimitive.Content
          ...
          {...props}
        >
          {!hasTitle && effectiveTitle ? (
            hideFallbackTitle ? (
              <VisuallyHiddenRoot>
                <SheetPrimitive.Title>{effectiveTitle}</SheetPrimitive.Title>
              </VisuallyHiddenRoot>
            ) : (
              <SheetPrimitive.Title>{effectiveTitle}</SheetPrimitive.Title>
            )
